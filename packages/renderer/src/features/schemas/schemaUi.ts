...
const validationMessages: Record<SchemaValidationError['code'], string> = {
  ...
  INVALID_SCHEMA_ID: '评分单元编号无效',
  INVALID_SOURCE_DRAFT_ID: '来源草稿编号无效',
  ...
  INVALID_ANSWER_ID: '答案槽位编号格式无效',
  DUPLICATE_ANSWER_ID: '答案槽位编号不能重复',
  ...
  INVALID_INPUT_ID: '输入项编号格式无效',
  DUPLICATE_INPUT_ID: '输入项编号不能重复',
  ...
  MISSING_OBJECTIVE_CORRECT_ANSWER: '客观题缺少内置正确答案输入',
  ...
  INVALID_DRAFT_ID: '草稿编号无效',
  INVALID_LIBRARY_ID: '草稿库编号无效',
  DUPLICATE_DRAFT_ID: '草稿编号不能重复',
  INVALID_SCORE: '分数无效',
