...
/*
 * This file is part of PocketTTS ONNX Export (https://github.com/KevinAHM/pocket-tts-onnx-export).
...
export class Model {
  ...
  start_generation(voice_index, token_ids, frames_after_eos, temperature) {
    ...
    const len0 = WASM_VECTOR_LEN
    const ret = wasm.model_start_generation(
      this.__wbg_ptr,
      voice_index,
      ptr0,
      len0,
